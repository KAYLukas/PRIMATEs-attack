...
unsigned char inv_sbox5[32] = {1, 0, 14, 19, 10, 9, 18, 21, 17, 25, 27, 30, 29, 20, 12, 16, 23, 4, 13, 31, 8, 6, 28, 11, 22, 2, 3, 7, 15, 5, 24, 26};
...
void InvSubElements(unsigned char *state) //SubElements operation on the state
{
	for(int i=0; i<StateSize; i++)
		state[i]=inv_sbox5[state[i]];
}
