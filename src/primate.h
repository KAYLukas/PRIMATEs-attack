...
void primate(unsigned char *state);
...
void PrintElementsStateHex(unsigned char *state);
...
void InvSubElements(unsigned char *state);
void SubElements(unsigned char *state);